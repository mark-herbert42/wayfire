...
class decoration_theme_t
{
  ...
  private:
    ...
    wf::option_wrapper_t<wf::color_t> active_text_color{"decoration/active_text_color"};
    wf::option_wrapper_t<wf::color_t> inactive_text_color{"decoration/inactive_text_color"};
